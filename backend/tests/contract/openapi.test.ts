...
const OPERACIONES_ESPERADAS: Array<[string, string]> = [
  ...
  ['get', '/bitacora'],
  ['get', '/padron/{nis}'], ['post', '/padron/importar'],
  ...
  ['post', '/tramites/{id}/validaciones/no-adeudo'], ['get', '/tramites/{id}/validaciones/no-adeudo/archivo'],
  ['post', '/tramites/{id}/validaciones/no-registro'], ['get', '/tramites/{id}/validaciones/no-registro/archivo'],
...
const RUTAS_CON_REQUEST_BODY = new Set([
  ...
  'put /administracion/constancias/{tipo}', 'post /padron/importar',
