...
describe('controles HTTP', () => {
  ...
  it('mantiene protegidos los subrouters internos por caso de uso', async () => {
    ...
    const requests = [
      ...
      request(app).get('/api/v1/tramites/00000000-0000-0000-0000-000000000000/validaciones/no-adeudo/archivo'),
      request(app).post('/api/v1/tramites/00000000-0000-0000-0000-000000000000/validaciones/no-registro'),
      request(app).get('/api/v1/tramites/00000000-0000-0000-0000-000000000000/validaciones/no-registro/archivo'),
